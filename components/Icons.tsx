...
export const Logo = ({ className }: { className?: string }) => (
  <svg className={className} viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M50 10 C 70 10, 85 25, 85 45 C 85 70, 65 90, 50 90 C 35 90, 15 70, 15 45 C 15 25, 30 10, 50 10 Z" stroke="currentColor" strokeWidth="5" />
    <path d="M35 50 L48 63 L65 40" stroke="#31FF75" strokeWidth="6" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
...
export const DumbbellIcon = ({ className }: { className?: string }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 6h3m-6.75 6.75h9.5m-9.5 0a4.5 4.5 0 01-4.5-4.5v-1.5a4.5 4.5 0 014.5-4.5h1.5a4.5 4.5 0 014.5 4.5v1.5a4.5 4.5 0 01-4.5 4.5m-9.5 0a4.5 4.5 0 004.5 4.5h1.5a4.5 4.5 0 004.5-4.5m-9.5 0h9.5" />
  </svg>
);

export const PlateIcon = ({ className }: { className?: string }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 10.5a8.25 8.25 0 01-16.5 0V9a8.25 8.25 0 0116.5 0v1.5z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 12.75v6.75m0 0l-3-3m3 3l3-3M3.375 10.5a8.25 8.25 0 0115.258-4.576.5.5 0 00.442-.443 8.25 8.25 0 00-16.14 0c.054.14.232.32.443.443A8.25 8.25 0 013.375 10.5z" />
    </svg>
);

export const ChartIcon = ({ className }: { className?: string }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 3v11.25A2.25 2.25 0 006 16.5h2.25M3.75 3h-1.5m1.5 0h16.5m0 0h1.5m-1.5 0v11.25A2.25 2.25 0 0118 16.5h-2.25m-7.5 0h7.5m-7.5 0l-1.5-1.5m1.5 1.5l1.5-1.5m-1.5 1.5V3.375c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V15M12 15v-4.5m0 4.5l-1.5-1.5m1.5 1.5l1.5-1.5" />
    </svg>
);
...
export const Cog6ToothIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-1.007 1.11-.95.54.056 1.007.52 1.065 1.064.058.541-.421 1.026-.963 1.083-1.442.155-2.76.79-3.9 1.697l-.84-2.433c-.09-.262-.39-.427-.665-.328-.276.099-.441.39-.342.664l.84 2.434c-1.408 1.458-2.24 3.44-2.24 5.613v.175c0 .621.504 1.125 1.125 1.125h16.5c.621 0 1.125-.504 1.125-1.125v-.175c0-2.172-.832-4.155-2.24-5.613l.84-2.434c.099-.274-.066-.565-.342-.664-.275-.099-.575.066-.665.328l-.84 2.433c-1.14-.907-2.458-1.542-3.9-1.697-.542-.057-1.022-.542-1.082-1.083z" />
